...
public class Q376WiggleSubsequence {
    public static void main(String[] args) {
        ...
        System.out.println(solution.wiggleMaxLength(new int[]{1, 4, 7, 2, 5}));
        System.out.println(solution.wiggleMaxLength(new int[]{1, 7, 4, 5, 5}));
        System.out.println(solution.wiggleMaxLength(new int[]{0,0}));
        System.out.println(solution.wiggleMaxLength(new int[]{0,0, 0}));
        System.out.println(solution.wiggleMaxLength(new int[]{1,10}));
    }
    ...
    class Solution {
        public int wiggleMaxLength(int[] nums) {
            ...
            for (int i = 0; i < nums.length - 1; i++) {
                diff[i] = Integer.compare(nums[i + 1] - nums[i], 0);
            }
