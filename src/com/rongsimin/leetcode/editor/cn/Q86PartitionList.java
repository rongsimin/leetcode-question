...
class Solution {
    public ListNode partition(ListNode head, int x) {
        ...
        ListNode ltDummyNode = ltNode;
        ListNode gtNode = new ListNode(-9);
        ListNode gtDummyNode = gtNode;
        while (head != null) {
            if (head.val < x) {
                ltNode.next = head;
                ltNode = ltNode.next;
        ...
        gtNode.next = null;
        ltNode.next = gtDummyNode.next;
        return ltDummyNode.next;
    }
}
